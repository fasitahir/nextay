...
Future<void> checkInRoom(int index) async {
            ...
            children: [
              ...
              InkWell(
                ...
                child: InputDecorator(
                  ...
                  child: Text(
                    (dob is DateTime) ? DateFormat('yyyy-MM-dd').format(dob) : 'Select Date'
                  ),
                ),
              ),
              TextField(
              ...
              DropdownButtonFormField<int>(
                ...
                items: const [
                  ...
                  DropdownMenuItem(value: 11, child: Text('National ID Card')),
                ],
          ...
          TextButton(
            ...
            onPressed: () {
              if (firstName.isEmpty || lastName.isEmpty || email.isEmpty || 
                  phoneNumber.isEmpty || address.isEmpty || dob == null || 
                  nationality.isEmpty) {
                ScaffoldMessenger.of(context).showSnackBar(
  ...
  try {
    ...
    final customerResponse = await http.post(
      ...
      body: json.encode({
        ...
        'dob': customerData.dob.toIso8601String(),
  ...
  Widget _buildSummarySection(double screenHeight, double screenWidth, bool isWeb) {
    return Container(
